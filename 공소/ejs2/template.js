  ...
  <body>
    ...
    >
      ...
      <div class="w3-bar-block">
        ...
        <a href="/fileUpload" class="w3-bar-item w3-button w3-padding">-파일업로드</a>
        <br />

        <a href="/rate" class="w3-bar-item w3-button w3-padding w3-blue"
          ><i class="far fa-star fa-fw"></i><b>Rate</b> </a
        >
        <a href="/scoreboard" class="w3-bar-item w3-button w3-padding"
          ><i class="far fa-clipboard fa-fw"></i><b>Scoreboard</b> </a
        >
      </div>
    </nav>
    ...
    <div class="w3-main w3-black" style="margin-left: 270px">
      ...
      <header class="w3-container" style="padding-top: 22px">
        <h5>
          <b> <i class="far fa-clipboard fa-fw"></i>Scoreboard</b>
        </h5>
      </header>
